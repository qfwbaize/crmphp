...
namespace wxalipay\paypal\Wxpay;

ini_set('date.timezone', 'Asia/Shanghai');
error_reporting(E_ERROR);

use wxalipay\paypal\Wxpay\lib\WxPayApi;
use wxalipay\paypal\Wxpay\lib\WxPayConfig;
use wxalipay\paypal\Wxpay\lib\WxPayException;
use wxalipay\paypal\Wxpay\lib\WxPayDataBase;
